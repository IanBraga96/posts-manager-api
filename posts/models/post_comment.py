...
class PostComment:
    def __init__(
        self, id, post_id, username, content, mentioned_users=None, created_at=None
    ):
        self.id = id
    ...
    @staticmethod
    def create(post_id, username, content, mentioned_users=None):
        doc_ref = db.collection("post_comments").document()
        comment = PostComment(doc_ref.id, post_id, username, content, mentioned_users)
